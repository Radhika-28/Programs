...
Input Format:
The first line is n which is the number of commands
Next following lines will have n commands
If the command is “goto” the next line will have link

Output Format:
The link the browser is in currently. Print “HOME” if the browser is on the home page.
